...
const charactersArray = [mrsPeacock,mrMustard,mrGreen,drOrchid,profPlum,missScarlet];
...
pickMistery:function(){return [this.randomSelector(charactersArray),this.randomSelector(weaponsArray),this.randomSelector(roomsArray)]},
revealMistery:function(mistery){
    return mistery[0].first_name.concat(' ',mistery[0].last_name,' killed Mr.Boddy using the ',mistery[1].name,' in the ', mistery[2].name,'!!!!')
